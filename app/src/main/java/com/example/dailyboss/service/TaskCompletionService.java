...
/**
 * Servis za upravljanje završavanjem zadataka i dodavanjem XP.
 */
public class TaskCompletionService {
    ...
    // Helper klasa za vraćanje rezultata
    ...
    /**
     * Završava zadatak i dodaje XP korisniku.
     * @param instanceId ID instance zadatka
     * @param newStatus Novi status (DONE, CANCELLED, itd.)
     * @return TaskCompletionResult sa informacijama o završavanju
     */
    public TaskCompletionResult completeTaskWithResult(String instanceId, TaskStatus newStatus) {
        ...
        // Uzmi template da bi znao težinu i važnost
        ...
        // Dodaj XP samo ako je status DONE
        if (newStatus == TaskStatus.DONE) {
            ...
            if (stats == null) {
                ...
                // Kreiraj novu statistiku za korisnika ako ne postoji
            ...
            // Kalkuliši XP prema trenutnom nivou korisnika
            ...
            // Dodaj XP i proveri da li je korisnik napredovao u nivou
            ...
            // Ažuriraj broj završenih zadataka
            ...
            if (leveledUp) {
                ...
                if (levelInfo != null) {
                    // Prikaži Toast o Level Up-u (možete zameniti sa custom dialog-om)
                    ...
                    // Pokreni Toast na main thread-u
    ...
    /**
     * Stara verzija za backward compatibility.
     * @deprecated Koristi completeTaskWithResult() za detaljnije informacije
     */
    @Deprecated
    ...
    /**
     * Listener za callback nakon završetka zadatka.
     */
    ...
    /**
     * Asinkrona verzija sa callback-om.
     */
