...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        ...
        holder.btnTaskOptions.setOnClickListener(v -> {
            ...
            // Proveri trenutni status zadatka
            ...
            // Sakrij opcije koje nisu dostupne za DONE/CANCELLED zadatke
            if (instance != null && (instance.getStatus() == TaskStatus.DONE || instance.getStatus() == TaskStatus.CANCELLED)) {
                ...
                // Samo "Obriši" opcija ostaje vidljiva
            } else {
                // Za Active/Paused zadatke sakrij "Obriši"
            ...
            popupMenu.setOnMenuItemClickListener(item -> {
                ...
                // Opcija za brisanje zadatka
                if (id == R.id.action_remove) {
                    // Koristi već postojeći instance iz scope-a iznad
                    if (instance != null && (instance.getStatus() == TaskStatus.DONE || instance.getStatus() == TaskStatus.CANCELLED)) {
                        // Obriši instance iz baze
                        ...
                        if (deleted) {
                            ...
                            // Pozovi callback da obavesti fragment da osvezi podatke
                ...
                if (newStatus != null) {
                    ...
                    if (result.success) {
                        // Prikaži Toast sa informacijom o dobijenim XP (samo za DONE status)
                        ...
                        // 🔄 Ažuriraj status u listi - task OSTAJE u listi
