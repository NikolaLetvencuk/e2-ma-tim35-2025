...
public class UserStatisticDao {
    ...
    public boolean upsert(UserStatistic userStatistic) {
        ...
        // UKLONJENO: values.put(DatabaseHelper.COL_STAT_COMPLETED_TASKS_BY_CATEGORY, gson.toJson(userStatistic.getCompletedTasksByCategory()));
        ...
        if (result == 0) { // Ako nijedan red nije ažuriran, ubacujemo novi
    ...
    public UserStatistic getUserStatistic(String userId) {
        ...
        if (cursor.moveToFirst()) {
            // UKLONJENO: Deserijalizacija mape
            userStatistic = new UserStatistic(
                    ...
                    // UKLONJENO: completedTasksByCategory,
    ...
    // Helper funkcija za bezbedno čitanje int vrednosti (ako kolona ne postoji, vrati default)
    ...
    // Helper funkcija za bezbedno čitanje long vrednosti
    ...
    // Helper funkcija za bezbedno čitanje String vrednosti
