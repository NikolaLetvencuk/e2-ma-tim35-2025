...
// Uklonjen java.util.List i java.util.Arrays

/**
 * Data Access Object za lokalno keširanje Alliance objekata.
 */
public class AllianceDao {
    ...
    private Alliance cursorToAlliance(Cursor cursor) {
        // Logika za memberIds je UKLONJENA
    ...
    private ContentValues allianceToContentValues(Alliance alliance) {
        ...
        // Polje memberIdsString je UKLONJENO

        return values;
    }

    // 1. Ubacivanje novog Saveza
    ...
    // 3. Ažuriranje Saveza (za ažuriranje imena, statusa misije, statusa itd.)
